...
from llmperf.ray_clients.openai_transcriptions_client import OpenAITranscriptionsClient
...
def construct_clients(llm_api: str, num_clients: int) -> List[LLMClient]:
    ...
    elif llm_api == "openai-audio":
        clients = [OpenAITranscriptionsClient.remote() for _ in range(num_clients)]
